...
RD_FILE_CSV = "../data/data_compare/rd.csv"
RD_ORIGINAL_FILE_CSV = "../data/data_compare/original_rd.csv"
RABEN_FILE_CSV = "../data/data_compare/raben.csv"
RABEN_ORIGINAL_FILE_CSV = "../data/data_compare/original_raben.csv"
