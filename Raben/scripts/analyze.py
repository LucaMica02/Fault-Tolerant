...
plotLog('../log/log1.csv', "Reduce-Scatter with pattern isend - recv - wait (no timeout)")
plotLog('../log/log2.csv', "Allgather with pattern isend - recv - wait (no timeout)")
plotLog('../log/log3.csv', "Rabenseifner with pattern isend - recv - wait (no timeout)")